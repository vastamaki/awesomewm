...
local globalkeys = my_table.join( -- Custom hotkeys
...
awful.key({modkey}, "l",
          function() awful.util.spawn("betterlockscreen -l dimblur") end),
awful.key({modkey, altkey}, "l",
          function() os.execute("betterlockscreen -l dimblur") end),
-- Tag browsing
...
local clientkeys = my_table.join(awful.key({modkey, "Shift"}, "c",
...
return function() return globalkeys, clientkeys, clientbuttons end
