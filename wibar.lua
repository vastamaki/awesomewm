    ...
    lain.widget.cpu(
        ...
        lain.widget.bat(
            ...
            lain.widget.net(
                {
                    settings = function()
                        widget:set_markup(markup.font(font, " " .. net_now.received .. " ↓↑ " .. net_now.sent .. ""))
                    end
                })
                ...
                awful.screen.connect_for_each_screen(function(s)
                    ...
                    s.topbar = awful.wibar({position = "top", screen = s, bg = "#282a36", wibar_shape = gears.shape.rounded_rect})
                        ...
                        nil,
                        {
                            ...
                            wibox.container.background(
                                wibox.container.margin(
                                    wibox.widget {_, network.widget, layout = wibox.layout.align.horizontal},
                                    dpi(2),
                                dpi(3)),
                                widget_colors.clock
                            ),
                            ...
                            wibox.container.background(
                                wibox.container.margin(
                                    wibox.widget {_, battery.widget, layout = wibox.layout.align.horizontal},
                                    dpi(2),
                                dpi(3)),
                                widget_colors.net
                            ),
                            ...
                            wibox.container.background(
                                wibox.container.margin(
                                    wibox.widget {_, cpu_usage.widget, layout = wibox.layout.align.horizontal},
                                    dpi(2),
                                dpi(3)),
                                widget_colors.temp
                            ...
                            wibox.container.background(
                                wibox.container.margin(
                                    wibox.widget {_, memory_usage.widget, layout = wibox.layout.align.horizontal},
                                    dpi(2),
                                dpi(3)),
                                widget_colors.cpu
                            ),
                            ...
                            wibox.container.background(
                                wibox.container.margin(
                                    wibox.widget {_, clock, layout = wibox.layout.align.horizontal},
                                    dpi(2),
                                dpi(3)),
                                widget_colors.clock
                            ),
